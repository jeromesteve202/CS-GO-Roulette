<html lang="en"><head>
		...
		<title>Withdraw - CSGOBANANAS.COM</title>
...
<div class="g-recaptcha" style="display:inline-block" data-sitekey="6LcFKx4TAAAAAB3CnLbpYG70UCVq0mnJuVe37xwZ" data-callback="xxx"></div>
</div>
...
<div id="inlineAlert" class="alert" style="font-weight:bold"></div>
				...
				<div class="panel panel-default text-left fw-4" style="vertical-align:top">
					...
					<div class="panel-body">
						<button class="btn btn-danger btn-lg" style="width:100%" onclick="showConfirm()" id="showConfirmButton">Display items<div style="font-size:12px"><span id="sum">0</span> Coins | Balance : <span id="avail">0</span></div></button>				
