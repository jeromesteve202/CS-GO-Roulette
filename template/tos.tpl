...
<html lang="en">
	<head>
		...
		<title>ToS - CSGOBANANAS.COM</title>
...
function redeem(){
	...
	$.ajax({
		...
		<div class="container" style="margin-bottom:20%">
            ...
            <p class="lead">
                <i>By using CSGOBananas.com (CB) you agree to the following terms of service. Violators may be barred from our service indefinitely, at the sole digression of CB staff!</i>
            </p>
            <h3>Item Pricing</h3>
