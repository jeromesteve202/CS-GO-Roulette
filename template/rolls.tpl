...
<html lang="en">
	<head>
		...
		<title>Provably Fair - CSGOBANANAS.COM</title>
	...
	$.ajax({
		...
		error:function(err){
			...
			<div class="panel panel-default">
				...
				<p>All rolls on CSGOBANANAS.COM are generated using a provably fair system. This means the operators cannot manipulate the outcome of any roll. Players may replicate any past roll using the below code:
				</p>
